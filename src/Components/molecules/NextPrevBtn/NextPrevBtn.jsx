...
const NextPrevBtn = ({ children, size, rightArrow, ...props }) => {
  const btn = (
    <BaseLink {...props} className="NextPrev">
      {rightArrow && (
        <>
          <svg
            version="1.1"
        ...
        >
          <g>
			...
			c13.895,23.791,20.838,49.772,20.838,77.943C374.58,247.436,367.637,273.417,353.742,297.208z"
              />
              <path
                d="M319.767,182.728h-100.5V127.91c0-2.474-0.903-4.616-2.712-6.423c-1.809-1.809-3.949-2.712-6.423-2.712
